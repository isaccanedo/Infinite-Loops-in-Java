...
public class RetrievingClassNameUnitTest {
    ...
    public void givenRetrievingClassName_whenGetName_thenCanonicalName() {
        assertEquals("com.isaccanedo.className.RetrievingClassName", RetrievingClassName.class.getName());
    }

    @Test
    public void givenRetrievingClassName_whenGetTypeName_thenCanonicalName() {
        assertEquals("com.isaccanedo.className.RetrievingClassName", RetrievingClassName.class.getTypeName());
    }

    @Test
    public void givenRetrievingClassName_whenGetCanonicalName_thenCanonicalName() {
        assertEquals("com.isaccanedo.className.RetrievingClassName", RetrievingClassName.class.getCanonicalName());
    }

    // - Inner Classes
    @Test
    public void givenRetrievingClassNameInnerClass_whenGetName_thenCanonicalNameWithDollarSeparator() {
        assertEquals("com.isaccanedo.className.RetrievingClassName$InnerClass", RetrievingClassName.InnerClass.class.getName());
    }

    @Test
    public void givenRetrievingClassNameInnerClass_whenGetTypeName_thenCanonicalNameWithDollarSeparator() {
        assertEquals("com.isaccanedo.className.RetrievingClassName$InnerClass", RetrievingClassName.InnerClass.class.getTypeName());
    }

    @Test
    public void givenRetrievingClassNameInnerClass_whenGetCanonicalName_thenCanonicalName() {
        assertEquals("com.isaccanedo.className.RetrievingClassName.InnerClass", RetrievingClassName.InnerClass.class.getCanonicalName());
    }
    ...
    public void givenAnonymousClass_whenGetName_thenCallingClassCanonicalNameWithDollarSeparatorAndCountNumber() {
        ...
        assertEquals("com.isaccanedo.className.RetrievingClassNameUnitTest$2", new RetrievingClassName() {}.getClass().getName());
        assertEquals("com.isaccanedo.className.RetrievingClassNameUnitTest$3", new RetrievingClassName() {}.getClass().getName());
    }
    ...
    public void givenAnonymousClass_whenGetTypeName_thenCallingClassCanonicalNameWithDollarSeparatorAndCountNumber() {
        ...
        assertEquals("com.isaccanedo.className.RetrievingClassNameUnitTest$4", new RetrievingClassName() {}.getClass().getTypeName());
        assertEquals("com.isaccanedo.className.RetrievingClassNameUnitTest$5", new RetrievingClassName() {}.getClass().getTypeName());
    }
    ...
    public void givenRetrievingClassNameArray_whenGetName_thenOpeningBracketsLetterLAndRetrievingClassNameGetName() {
        assertEquals("[Lcom.isaccanedo.className.RetrievingClassName;", RetrievingClassName[].class.getName());
        assertEquals("[[Lcom.isaccanedo.className.RetrievingClassName;", RetrievingClassName[][].class.getName());
    }
    ...
    public void givenRetrievingClassNameInnerClassArray_whenGetName_thenOpeningBracketsLetterLAndRetrievingClassNameInnerClassGetName() {
        assertEquals("[Lcom.isaccanedo.className.RetrievingClassName$InnerClass;", RetrievingClassName.InnerClass[].class.getName());
        assertEquals("[[Lcom.isaccanedo.className.RetrievingClassName$InnerClass;", RetrievingClassName.InnerClass[][].class.getName());
    }
